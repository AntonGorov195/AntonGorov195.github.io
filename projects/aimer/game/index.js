...
Module['FS_createPath']("/assets", "textures", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/fonts/Calistoga-Regular.ttf", "start": 0, "end": 47144}, {"filename": "/assets/fonts/CarroisGothicSC-Regular.ttf", "start": 47144, "end": 87500}, {"filename": "/assets/fonts/Counter.ttf", "start": 87500, "end": 89892}, {"filename": "/assets/music/knife.wav", "start": 89892, "end": 46928190}, {"filename": "/assets/sounds/buy.wav", "start": 46928190, "end": 47005034}, {"filename": "/assets/sounds/click1.wav", "start": 47005034, "end": 47034602}, {"filename": "/assets/sounds/click2.wav", "start": 47034602, "end": 47064170}, {"filename": "/assets/sounds/no_money.wav", "start": 47064170, "end": 47128726}, {"filename": "/assets/sounds/pew.ogg", "start": 47128726, "end": 47136287}, {"filename": "/assets/textures/err.png", "start": 47136287, "end": 47136810}, {"filename": "/assets/textures/round_cat.png", "start": 47136810, "end": 47137147}], "remote_package_size": 47137147});

  })();

// end include: /tmp/tmpebbukn04.js
// include: /tmp/tmpaqaw8xqd.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpaqaw8xqd.js
// include: /tmp/tmp_k84tl1s.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp_k84tl1s.js
...
var ASM_CONSTS = {
  194984: () => { if (document.fullscreenElement) return 1; },  
 195030: () => { return document.getElementById('canvas').width; },  
 195082: () => { return parseInt(document.getElementById('canvas').style.width); },  
 195150: () => { document.exitFullscreen(); },  
 195177: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 195250: () => { if (document.fullscreenElement) return 1; },  
 195296: () => { return document.getElementById('canvas').width; },  
 195348: () => { return screen.width; },  
 195373: () => { document.exitFullscreen(); },  
 195400: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 195533: () => { return window.innerWidth; },  
 195559: () => { return window.innerHeight; },  
 195586: () => { if (document.fullscreenElement) return 1; },  
 195632: () => { return document.getElementById('canvas').width; },  
 195684: () => { return parseInt(document.getElementById('canvas').style.width); },  
 195752: () => { if (document.fullscreenElement) return 1; },  
 195798: () => { return document.getElementById('canvas').width; },  
 195850: () => { return screen.width; },  
 195875: () => { return window.innerWidth; },  
 195901: () => { return window.innerHeight; },  
 195928: () => { if (document.fullscreenElement) return 1; },  
 195974: () => { return document.getElementById('canvas').width; },  
 196026: () => { return screen.width; },  
 196051: () => { document.exitFullscreen(); },  
 196078: () => { if (document.fullscreenElement) return 1; },  
 196124: () => { return document.getElementById('canvas').width; },  
 196176: () => { return parseInt(document.getElementById('canvas').style.width); },  
 196244: () => { document.exitFullscreen(); },  
 196271: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 196329: () => { return screen.width; },  
 196354: () => { return screen.height; },  
 196380: () => { return window.screenX; },  
 196407: () => { return window.screenY; },  
 196434: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 196487: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 196558: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 196615: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 196871: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 196942: () => { if (document.fullscreenElement) return 1; },  
 196988: () => { return window.innerWidth; },  
 197014: () => { return window.innerHeight; },  
 197041: () => { if (document.pointerLockElement) return 1; },  
 197088: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 199246: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 199410: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 199514: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 ...
 202513: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 202579: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 202972: ($0) => { miniaudio.untrack_device_by_index($0); },  
 203015: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 203140: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
