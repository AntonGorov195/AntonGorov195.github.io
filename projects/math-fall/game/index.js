...
Module['FS_createPath']("/assets", "textures", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/fonts/Calistoga-Regular.ttf", "start": 0, "end": 47144}, {"filename": "/assets/fonts/CarroisGothicSC-Regular.ttf", "start": 47144, "end": 87500}, {"filename": "/assets/fonts/dejavu-sans-mono.book.ttf", "start": 87500, "end": 422568}, {"filename": "/assets/sounds/buy.wav", "start": 422568, "end": 499412}, {"filename": "/assets/sounds/click1.wav", "start": 499412, "end": 528980}, {"filename": "/assets/sounds/click2.wav", "start": 528980, "end": 558548}, {"filename": "/assets/sounds/no_money.wav", "start": 558548, "end": 623104}, {"filename": "/assets/sounds/pew.ogg", "start": 623104, "end": 630665}, {"filename": "/assets/textures/angry.png", "start": 630665, "end": 632121}, {"filename": "/assets/textures/cat.kra", "start": 632121, "end": 769059}, {"filename": "/assets/textures/cat.kra~", "start": 769059, "end": 921537}, {"filename": "/assets/textures/err.png", "start": 921537, "end": 922060}, {"filename": "/assets/textures/idle.png", "start": 922060, "end": 923487}, {"filename": "/assets/textures/nice.png", "start": 923487, "end": 924930}, {"filename": "/assets/textures/sad.png", "start": 924930, "end": 926545}, {"filename": "/assets/textures/sleep.png", "start": 926545, "end": 928097}, {"filename": "/assets/textures/super.png", "start": 928097, "end": 930233}, {"filename": "/assets/textures/tired.png", "start": 930233, "end": 931603}], "remote_package_size": 931603});

  })();

// end include: /tmp/tmpkq3s47j5.js
// include: /tmp/tmpcnzeqqop.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpcnzeqqop.js
// include: /tmp/tmp4pla9nho.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp4pla9nho.js
...
// Begin JS library code
  ...
  /** @type {function(...*):?} */
  function __read_local_storage(
  ) {
  abort('missing function: _read_local_storage');
  }
  __read_local_storage.stub = true;

  /** @type {function(...*):?} */
  function __read_local_storage_length(
  ) {
  abort('missing function: _read_local_storage_length');
  }
  __read_local_storage_length.stub = true;

  /** @type {function(...*):?} */
  function __write_local_storage(
  ) {
  abort('missing function: _write_local_storage');
  }
  __write_local_storage.stub = true;
...
var ASM_CONSTS = {
  175552: () => { if (document.fullscreenElement) return 1; },  
 175598: () => { return document.getElementById('canvas').width; },  
 175650: () => { return parseInt(document.getElementById('canvas').style.width); },  
 175718: () => { document.exitFullscreen(); },  
 175745: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 175818: () => { if (document.fullscreenElement) return 1; },  
 175864: () => { return document.getElementById('canvas').width; },  
 175916: () => { return screen.width; },  
 175941: () => { document.exitFullscreen(); },  
 175968: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 176101: () => { return window.innerWidth; },  
 176127: () => { return window.innerHeight; },  
 176154: () => { if (document.fullscreenElement) return 1; },  
 176200: () => { return document.getElementById('canvas').width; },  
 176252: () => { return parseInt(document.getElementById('canvas').style.width); },  
 176320: () => { if (document.fullscreenElement) return 1; },  
 176366: () => { return document.getElementById('canvas').width; },  
 176418: () => { return screen.width; },  
 176443: () => { return window.innerWidth; },  
 176469: () => { return window.innerHeight; },  
 176496: () => { if (document.fullscreenElement) return 1; },  
 176542: () => { return document.getElementById('canvas').width; },  
 176594: () => { return screen.width; },  
 176619: () => { document.exitFullscreen(); },  
 176646: () => { if (document.fullscreenElement) return 1; },  
 176692: () => { return document.getElementById('canvas').width; },  
 176744: () => { return parseInt(document.getElementById('canvas').style.width); },  
 176812: () => { document.exitFullscreen(); },  
 176839: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 176897: () => { return screen.width; },  
 176922: () => { return screen.height; },  
 176948: () => { return window.screenX; },  
 176975: () => { return window.screenY; },  
 177002: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 177055: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 177126: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 177183: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 177439: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 177510: () => { if (document.fullscreenElement) return 1; },  
 177556: () => { return window.innerWidth; },  
 177582: () => { return window.innerHeight; },  
 177609: () => { if (document.pointerLockElement) return 1; },  
 177656: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 179814: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 179978: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 180082: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 ...
 183081: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 183147: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 183540: ($0) => { miniaudio.untrack_device_by_index($0); },  
 183583: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 183708: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};

// Imports from the Wasm binary.
var _game_ui = Module['_game_ui'] = makeInvalidEarlyAccess('_game_ui');
...
var _errorHandler = Module['_errorHandler'] = makeInvalidEarlyAccess('_errorHandler');
...
var _game_pre_hot_reloaded = Module['_game_pre_hot_reloaded'] = makeInvalidEarlyAccess('_game_pre_hot_reloaded');
...
var _game_post_hot_reloaded = Module['_game_post_hot_reloaded'] = makeInvalidEarlyAccess('_game_post_hot_reloaded');
var _main_end = Module['_main_end'] = makeInvalidEarlyAccess('_main_end');
var _game_end = Module['_game_end'] = makeInvalidEarlyAccess('_game_end');
...
function assignWasmExports(wasmExports) {
  Module['_game_ui'] = _game_ui = createExportWrapper('game_ui', 1);
  ...
  Module['_game_start'] = _game_start = createExportWrapper('game_start', 1);
  Module['_default_context_ptr'] = _default_context_ptr = createExportWrapper('default_context_ptr', 0);
  Module['_errorHandler'] = _errorHandler = createExportWrapper('errorHandler', 1);
  ...
  Module['_game_pre_hot_reloaded'] = _game_pre_hot_reloaded = createExportWrapper('game_pre_hot_reloaded', 1);
  ...
  Module['_game_post_hot_reloaded'] = _game_post_hot_reloaded = createExportWrapper('game_post_hot_reloaded', 2);
  Module['_main_end'] = _main_end = createExportWrapper('main_end', 0);
  Module['_game_end'] = _game_end = createExportWrapper('game_end', 1);
...
var wasmImports = {
  ...
  /** @export */
  _read_local_storage: __read_local_storage,
  /** @export */
  _read_local_storage_length: __read_local_storage_length,
  /** @export */
  _write_local_storage: __write_local_storage,
  /** @export */
