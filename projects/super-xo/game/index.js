...
Module['FS_createPath']("/assets", "sounds", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/fonts/Calistoga-Regular.ttf", "start": 0, "end": 47144}, {"filename": "/assets/fonts/dejavu-sans-mono.book.ttf", "start": 47144, "end": 382212}, {"filename": "/assets/sounds/.gitignore", "start": 382212, "end": 382217}, {"filename": "/assets/sounds/dum.wav", "start": 382217, "end": 443435}], "remote_package_size": 443435});

  })();

// end include: /tmp/tmpwuy8iuk0.js
// include: /tmp/tmp70zugw9f.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp70zugw9f.js
// include: /tmp/tmp_hnowv6p.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp_hnowv6p.js
...
var ASM_CONSTS = {
  190608: () => { if (document.fullscreenElement) return 1; },  
 190654: () => { return document.getElementById('canvas').width; },  
 190706: () => { return parseInt(document.getElementById('canvas').style.width); },  
 190774: () => { document.exitFullscreen(); },  
 190801: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 190874: () => { if (document.fullscreenElement) return 1; },  
 190920: () => { return document.getElementById('canvas').width; },  
 190972: () => { return screen.width; },  
 190997: () => { document.exitFullscreen(); },  
 191024: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 191157: () => { return window.innerWidth; },  
 191183: () => { return window.innerHeight; },  
 191210: () => { if (document.fullscreenElement) return 1; },  
 191256: () => { return document.getElementById('canvas').width; },  
 191308: () => { return parseInt(document.getElementById('canvas').style.width); },  
 191376: () => { if (document.fullscreenElement) return 1; },  
 191422: () => { return document.getElementById('canvas').width; },  
 191474: () => { return screen.width; },  
 191499: () => { return window.innerWidth; },  
 191525: () => { return window.innerHeight; },  
 191552: () => { if (document.fullscreenElement) return 1; },  
 191598: () => { return document.getElementById('canvas').width; },  
 191650: () => { return screen.width; },  
 191675: () => { document.exitFullscreen(); },  
 191702: () => { if (document.fullscreenElement) return 1; },  
 191748: () => { return document.getElementById('canvas').width; },  
 191800: () => { return parseInt(document.getElementById('canvas').style.width); },  
 191868: () => { document.exitFullscreen(); },  
 191895: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 191953: () => { return screen.width; },  
 191978: () => { return screen.height; },  
 192004: () => { return window.screenX; },  
 192031: () => { return window.screenY; },  
 192058: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 192111: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 192182: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 192239: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 192495: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 192566: () => { if (document.fullscreenElement) return 1; },  
 192612: () => { return window.innerWidth; },  
 192638: () => { return window.innerHeight; },  
 192665: () => { if (document.pointerLockElement) return 1; },  
